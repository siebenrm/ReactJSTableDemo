	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement('input', { id: 'firstName' + this.props.index, defaultValue: this.props.tableRow.firstName }) : this.props.tableRow.firstName
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement('input', { id: 'lastName' + this.props.index, defaultValue: this.props.tableRow.lastName }) : this.props.tableRow.lastName
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement('input', { id: 'email' + this.props.index, defaultValue: this.props.tableRow.email }) : this.props.tableRow.email
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement(
	                    ...
	                    React.createElement(
	                        'button',
	                        { name: 'save', onClick: this.onClickHandler },
	                        'Save'
	                    ),
	                    React.createElement(
	                        'button',
	                        { name: 'cancel', onClick: this.onClickHandler },
	                        'Cancel'
	                    )
	                ) : React.createElement(
	                    'button',
	                    { name: 'edit', onClick: this.onClickHandler },
	                    'Edit'
	                )
	            )
	        );
