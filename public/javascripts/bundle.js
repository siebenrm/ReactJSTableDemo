...
/***/ function(module, exports, __webpack_require__) {
	...
	var DemoTable = __webpack_require__(159);
	...
	var Main = React.createClass({
	    ...
	    render: function render() {
	        return React.createElement(DemoTable, null);
	    }
	});
...
/***/ function(module, exports, __webpack_require__) {
	    ...
	    render: function render() {
	        return React.createElement(
	            ...
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement('input', { id: 'firstName' + this.props.index, className: 'form-control', maxLength: '20', defaultValue: this.props.tableRow.firstName }) : this.props.tableRow.firstName
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement('input', { id: 'lastName' + this.props.index, className: 'form-control', maxLength: '20', defaultValue: this.props.tableRow.lastName }) : this.props.tableRow.lastName
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement('input', { id: 'email' + this.props.index, className: 'form-control', maxLength: '60', defaultValue: this.props.tableRow.email }) : this.props.tableRow.email
	            ),
	            React.createElement(
	                'td',
	                null,
	                this.props.tableRow.mode === 'edit' ? React.createElement(
	                    'span',
	                    null,
	                    React.createElement(
	                        'button',
	                        { name: 'save', onClick: this.onClickHandler, className: 'btn btn-default btn-block' },
	                        'Save'
	                    ),
	                    React.createElement(
	                        'button',
	                        { name: 'cancel', onClick: this.onClickHandler, className: 'btn btn-default btn-block' },
	                        'Cancel'
	                    )
	                ) : React.createElement(
	                    'span',
	                    ...
	                    React.createElement(
	                        'button',
	                        { name: 'edit', onClick: this.onClickHandler, className: 'btn btn-default btn-block' },
	                        'Edit'
	                    ),
	                    React.createElement(
	                        'button',
	                        { name: 'delete', onClick: this.onClickHandler, className: 'btn btn-default btn-block' },
	                        'Delete'
	                    )
	                )
	            )
	...
	var DemoTable = React.createClass({
	    displayName: 'DemoTable',

	    onClickAddHandler: function onClickAddHandler(event) {
	        var tableRows = this.state.tableRows;
	        tableRows.push({ firstName: 'New', lastName: 'Row', email: 'newRow@gmail.com', mode: 'edit' });
	        this.setState(tableRows);
	    },
	    onClickRowHandler: function onClickRowHandler(index, event, rowData) {
	    ...
	    render: function render() {
	        var tableRows = this.state.tableRows.map(function (tableRow, index) {
	            ...
	            return React.createElement(DemoRow, { key: index, index: index, tableRow: tableRow, onClick: onClickRowHandler });
	        }, this);
	        ...
	        return React.createElement(
	            ...
	            React.createElement(
	                ...
	                React.createElement(
	                    ...
	                    React.createElement(
	                        'button',
	                        { name: 'add', onClick: this.onClickAddHandler, className: 'btn btn-primary' },
	                        'Add'
	                    )
	                )
	            )
